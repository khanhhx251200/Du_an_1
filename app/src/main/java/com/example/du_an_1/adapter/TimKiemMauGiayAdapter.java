...
public class TimKiemMauGiayAdapter extends BaseAdapter {
    Context context;
    List<MauGiay> mauGiayList;
    List<HangGiay> hangGiayList;
    MauGiayDAO mauGiayDAO;

    public TimKiemMauGiayAdapter(Context context, List<MauGiay> mauGiayList, List<HangGiay> hangGiayList) {
